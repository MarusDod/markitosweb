...
export default () => (
    <>
        ...
        <Paragraph center>
            <img width="1em" alt="monero icon" src="https://cdn.cdnlogo.com/logos/m/88/monero.svg" />
            {''} Address:
        </Paragraph>
        <div style={{display: 'flex',width:"80%",marginBottom:"1em",whiteSpace:"nowrap"}}>
            ...
            <button className="btn btn-secondary" onClick={copyToClipboard} title="copy to clipboard">
                <svg xmlns="https://www.w3.org/2000/svg" title="copy to clipboard" width="20" height="30" fill="currentColor" className="bi bi-clipboard" viewBox="0 0 16 16">
